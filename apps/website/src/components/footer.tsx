  ...
  return (
    <div className="flex items-center space-x-3">
      ...
      <div className="flex items-center space-x-2">
        ...
        <a href="https://x.com/0xdsqr" className="hover:text-primary transition-colors">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 24 24"
            className="w-5 h-5"
...
export function Footer() {
  return (
    <footer className="py-4">
      <div className="max-w-2xl mx-auto px-4 border-t border-border pt-4 text-sm text-muted-foreground">
